...
static void _hw_hardware_component_class(coreconf_encoder_t *enc, const coreconf_node_t *node,
                                         void **argv)
{
    (void)node;
    (void)argv;
...
static int _hw_hardware_component_description(coreconf_encoder_t *enc, const coreconf_node_t *node,
                                              void **argv)
{
    (void)node;
    const saul_reg_t *dev = _get_dev(&enc->ctx, argv);
...
static int _fmt_hw_hardware_component_sensor(coreconf_encoder_t *enc, const coreconf_node_t *node,
