...
The workflow described here aims to update the firmware on real-world hardware.
For using the SUIT workflow on the native Linux instance see 
[here](https://github.com/RIOT-OS/RIOT/tree/master/examples/suit_update/README.native.md)
