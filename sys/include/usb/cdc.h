...
#define USB_CDC_PROTOCOL_NONE          0x00 /* Not required */
...
typedef struct {
    plumbum_handler_t handler_ctrl;
   // plumbum_handler_t handler_data;
    plumbum_interface_t iface_ctrl;
    plumbum_interface_t iface_data;
    plumbum_endpoint_t ep_ctrl;
    plumbum_endpoint_t ep_data_in;
    plumbum_endpoint_t ep_data_out;
    plumbum_hdr_gen_t cdc_hdr;
    plumbum_hdr_gen_t acm_hdr;
    plumbum_hdr_gen_t union_hdr;
    plumbum_hdr_gen_t call_mngt_hdr;
} plumbum_cdc_device_t;
